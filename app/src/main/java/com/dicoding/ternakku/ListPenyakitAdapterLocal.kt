...
class ListPenyakitAdapterLocal(private var listPenyakit: ArrayList<Disease>) :
    RecyclerView.Adapter<ListPenyakitAdapterLocal.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        val view: View =
            LayoutInflater.from(parent.context).inflate(R.layout.list_penyakit, parent, false)
